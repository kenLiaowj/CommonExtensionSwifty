#
#  Be sure to run `pod spec lint CommonExtensionSwifty.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  Common extension in swift, help developer use easily.
                   DESC

  spec.homepage     = "https://github.com/kenLiaowj/CommonExtensionSwifty.git"
  ...
  spec.author             = { "admin" => "" }
  # Or just: spec.author    = "admin"
  # spec.authors            = { "admin" => "" }
  # spec.social_media_url   = "https://twitter.com/admin"
  ...
  spec.source       = { :git => "https://github.com/kenLiaowj/CommonExtensionSwifty.git", :tag => "#{spec.version}" }
